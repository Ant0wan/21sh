...
#    Updated: 2020/05/27 12:19:03 by abarthel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES	:= \
		...
		ds_singly_linked_list/ft_lst_del_if.c \
		...
		f_ctype/ft_is_posix_portable_charset.c \
...
CFLAGS += -Wall -Werror -Wextra -ansi -std=c99 -g3 -D_POSIX_C_SOURCE
